...
Nos han pedido que escribamos un programa que nos diga qué regalos hay que comprar para reponer en nuestros almacenes ahora 
que se acerca la Navidad. Un regalo se tiene que reponer cuando sólo hay stock en uno de los tres almacenes.
...
Como ves, los almacenes pueden tener el mismo regalo repetido varias veces. Pero, por más existencias que haya en un almacén, 
si no tenemos en los otros dos, debemos reponerlo para tener mejor distribución.
...
function getGiftsToRefill(a1, a2, a3) {
  const newArray = [...new Set(a1),...new Set(a2),...new Set(a3)]
  const filtrar = newArray.filter((elements) => 
  newArray.indexOf(elements) === newArray.lastIndexOf(elements)
  );
  return filtrar;
}
